/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3d271d557e796373f3d15aea25b0452)
// Runtime types generated with workerd@1.20250803.0 2025-02-04 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		...
		Mc2fiMCPAgent: DurableObjectNamespace<import("./src/server").Mc2fiMCPAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "TYPESENSE_API_KEY" | "AMPLITUDE_API_KEY">> {}
}
